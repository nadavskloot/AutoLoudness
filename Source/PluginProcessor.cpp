...
//        DBG(isAdjust.toString());
    ...
    //                channelData[sample] = channelData[sample] * juce::Decibels::decibelsToGain(decibels);
//                    channelData[sample] = channelData[sample] * juce::Decibels::decibelsToGain(integratedLoudnessDiff);
...
void LUFSMeter_BasicAudioProcessor::reset1()
{
